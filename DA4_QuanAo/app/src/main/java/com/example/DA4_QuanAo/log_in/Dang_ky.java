package com.example.DA4_QuanAo.log_in;

import static com.example.DA4_QuanAo.xuly.dia;
import static com.example.DA4_QuanAo.xuly.on_back;
...
import com.example.DA4_QuanAo.MainActivity;
                    ...
                    API.API.kiemtra(email1, mk1).enqueue(new Callback<List<taikhoan>>() {
                        ...
                        public void onResponse(Call<List<taikhoan>> call, Response<List<taikhoan>> response) {
                            if (!response.isSuccessful()) {
                                ...
                                API.API.post_tk(taikhoan).enqueue(new Callback<com.example.DA4_QuanAo.models.taikhoan>() {
                                    @Override
