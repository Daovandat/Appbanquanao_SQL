...
import static com.example.DA4_QuanAo.Home.Home.currencyVN;
import static com.example.DA4_QuanAo.Home.Home.idtk;
import static com.example.DA4_QuanAo.xuly.dia;
import static com.example.DA4_QuanAo.xuly.on_back1;
...
import com.example.DA4_QuanAo.API.quantilist;
import com.example.DA4_QuanAo.API.gettien;
import com.example.DA4_QuanAo.Home.Home;
import com.example.DA4_QuanAo.R;
import com.example.DA4_QuanAo.models.chon;
...
public class ct_sp extends Fragment {
    ...
    private void kiemtra() {
        quantilist = new quantilist() {
            ...
            public void onlist(ArrayList<String> arrayList) {
                Log.e("Chọn size", arrayList.toString());
                arrayLis1 = arrayList;
            }
    ...
    private void getdata() {
        ...
        API.API.getchitiet(idsp).enqueue(new Callback<san_pham>() {
            ...
            public void onResponse(Call<san_pham> call, Response<san_pham> response) {
                if (response.isSuccessful()) {
                    ...
                    giatiensp.setText(currencyVN.format((san_pham.getGiatien())));
                    tong1 = san_pham.getGiatien();
                    tong2 = tong1;
        ...
        API.API.Getall_chon("Chọn màu sắc").enqueue(new Callback<List<chon>>() {
            @Override
                ...
                if (response.isSuccessful()) {
                    ...
                    gettien = new gettien() {
                        ...
                        public void test(String tong) {
                            mau = tong;
                            ongiohang();
                            int chọn_màu_sắc = Log.e("Chọn màu sắc", mau);
                        }
                    ...
                    chon_adpater = new chon_adpater(chons, "Chọn màu sắc", recy_3, quantilist, gettien);
...
//            }
//        });
//        API.API.Getall_chon("Chọn phương thức vận chuyển").enqueue(new Callback<List<chon>>() {
//            @Override
//            public void onResponse(Call<List<chon>> call, Response<List<chon>> response) {
//                if (response.isSuccessful()) {
//                    chons = (ArrayList<chon>) response.body();
//                    Log.e("mang top", "" + chons.toString());
//                    recy_7.setLayoutManager(new LinearLayoutManager(getContext(), RecyclerView.VERTICAL, false));
//                    chon_adpater = new chon_adpater(chons, "Chọn phương thức vận chuyển", recy_7, quantilist, gettien);
...
//
    ...
    public void ongiohang() {
        ...
        layout1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.show();
                if (mau.isEmpty() || size.isEmpty()) {
                    check(mau, "Vui lòng chọn màu sắc");
                    check(size, "Vui lòng chọn size");

                } else {
                    String a = arrayLis1.toString().replaceAll("[\\[\\]]", "");
                    giohang giohang = new giohang(0,idtk, idsp, tong3 , mau + ", " + size + ", " + a, "" + tong2, tong4, "không");
                    API.API.addgiohang(giohang).enqueue(new Callback<com.example.DA4_QuanAo.models.giohang>() {
                        @Override
                        public void onResponse(Call<com.example.DA4_QuanAo.models.giohang> call, Response<com.example.DA4_QuanAo.models.giohang> response) {
                            if (response.isSuccessful()) {
                                dialog.dismiss();
                        ...
                        @Override
                        public void onFailure(Call<com.example.DA4_QuanAo.models.giohang> call, Throwable t) {
