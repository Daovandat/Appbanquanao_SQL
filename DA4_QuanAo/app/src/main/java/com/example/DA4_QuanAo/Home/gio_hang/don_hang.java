package com.example.DA4_QuanAo.Home.gio_hang;
...
import static com.example.DA4_QuanAo.xuly.kiemtra_tt;
...
import com.example.DA4_QuanAo.models.donhang;
import com.example.DA4_QuanAo.models.giohang;
import com.example.DA4_QuanAo.models.taikhoan;
                        ...
                        public void onResponse(Call<List<giohang>> call, Response<List<giohang>> response) {
                            if (response.isSuccessful()) {
                                ...
                                for (giohang d:arrayList){
                                    ...
                                    API.API.Postdonhang(donhang).enqueue(new Callback<com.example.DA4_QuanAo.models.donhang>() {
                                        @Override
                                        public void onResponse(Call<com.example.DA4_QuanAo.models.donhang> call, Response<com.example.DA4_QuanAo.models.donhang> response) {
                                            if (response.isSuccessful()){

                                                giohang giohang=new giohang(d.getIdgh(),d.getIdtk(),d.getIdsp(),d.getSl(),d.getChon(),d.getGiax1(),d.getTongtien(),"đơn hàng");
                                                API.API.Putgiohang(d.getIdgh(),giohang).enqueue(new Callback<com.example.DA4_QuanAo.models.giohang>() {
                                                    @Override
                                        ...
                                        @Override
                                        public void onFailure(Call<com.example.DA4_QuanAo.models.donhang> call, Throwable t) {
                                            dialog.dismiss();
